...
@section('title', '确认账号信息')

@section('content')

    <div class="seven wide column mt150 mb100">
                ...
                <form class="ui form" role="form" method="POST" action="{{ route('signup') }}" accept-charset="UTF-8">
                    ...
                    <div class="field">
                        <div class="ui left icon input">
                            <i class="user icon"></i>
                            <input type="text" name="username" placeholder="用户名" value="{{ $oauthData['name'] ?: '' }}" required="">
                        </div>
                    </div>
                    <div class="field">
                        <div class="ui left icon input">
                    ...
                    @if($oauthData['driver'] == 'github')
                        <div class="field">
                            <div class="ui left icon input">
                                ...
                                <input type="text" name="github_name" placeholder="Github Name" value="{{ $oauthData['name'] ? : $oauthData['username'] }}" required="">
                            </div>
                        </div>
                    @endif
