...
return [
    ...
    'Sorry, You account is banned.' => '对不起，您的账号已被禁用！<br>如有疑问，请联系 Evan ',
    ...
    'Weibo Username example: name' => '如：name',
    'Weibo ID example: 111' => '用来拼接 URL 的，如：111',
    'twitter_placeholder_hint' => '如：name',
    ...
    'site_intro' => '',
    'contributing' => '',
    'be_nice' => '我们希望 In Note 能够成为拥有浓厚技术氛围的开发者社区，而实现这个目标，需要我们所有人的共同努力：友善，公平，尊重知识和事实。请严格遵守 - <a href="">社区发帖和管理规范</a>',
    ...
    'Do not post duplicate topics!' => '请不要发布重复话题！',
    'Login Successfully.' => '成功登录！',
    'Congratulations and Welcome!' => '恭喜，欢迎加入 In Note ！',
    ...
    'Setup multiple Bindings allow you to login to the same account with different binding site account.' => '绑定多个第三方账号，允许你使用任意一个第三方账号登录同一个 In Note 账号。',
    ...
    'The mail send failed! Please fill in your email address first.' => '邮箱不存在，请点击 <a href="' .url(route('users.profile', user()->username)). '" target="_blank">此处</a> 编辑你的邮箱！',
    ...
    'Bind Successfully!' => '绑定成功！以后可以使用你的 :driver 账号登录 In Note 了 ^_^',
    'Actived' => '最近访问',
];
